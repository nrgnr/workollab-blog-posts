---
title: Why vibe coding burns people out
slug: why-vibe-coding-burns-people-out
tags:
  - Blog Posts
excerpt: The real cost of vibe coding is not just bad code. It is the burnout that comes from weeks of prompting, rework, and unfinished systems.
---
...
1. You start with excitement.
2. You subscribe to several AI tools because each one does something slightly different.
3. You spend days or weeks prompting, debugging, re-prompting, and stitching outputs together.
4. You get something that sort of works.
5. You try to extend it, deploy it, or trust it in production.
6. The whole thing starts to come apart.
